...
Group.new('lualine_b_diff_added_normal', colors.diff_add)
Group.new('lualine_b_diff_added_insert', colors.diff_add)
Group.new('lualine_b_diff_added_visual', colors.diff_add)
Group.new('lualine_b_diff_added_replace', colors.diff_add)
Group.new('lualine_b_diff_added_command', colors.diff_add)
Group.new('lualine_b_diff_added_terminal', colors.diff_add)
Group.new('lualine_b_diff_added_inactive', colors.diff_add)

Group.new('lualine_b_diff_modified_normal', colors.diff_change)
Group.new('lualine_b_diff_modified_insert', colors.diff_change)
Group.new('lualine_b_diff_modified_visual', colors.diff_change)
Group.new('lualine_b_diff_modified_replace', colors.diff_change)
Group.new('lualine_b_diff_modified_command', colors.diff_change)
Group.new('lualine_b_diff_modified_terminal', colors.diff_change)
Group.new('lualine_b_diff_modified_inactive', colors.diff_change)

Group.new('lualine_b_diff_removed_normal', colors.diff_delete)
Group.new('lualine_b_diff_removed_insert', colors.diff_delete)
Group.new('lualine_b_diff_removed_visual', colors.diff_delete)
Group.new('lualine_b_diff_removed_replace', colors.diff_delete)
Group.new('lualine_b_diff_removed_command', colors.diff_delete)
Group.new('lualine_b_diff_removed_terminal', colors.diff_delete)
Group.new('lualine_b_diff_removed_inactive', colors.diff_delete)
...
Group.new('lualine_x_diff_added_normal', colors.diff_add)
Group.new('lualine_x_diff_added_insert', colors.diff_add)
Group.new('lualine_x_diff_added_visual', colors.diff_add)
Group.new('lualine_x_diff_added_replace', colors.diff_add)
Group.new('lualine_x_diff_added_command', colors.diff_add)
Group.new('lualine_x_diff_added_terminal', colors.diff_add)
Group.new('lualine_x_diff_added_inactive', colors.diff_add)

Group.new('lualine_x_diff_modified_normal', colors.diff_change)
Group.new('lualine_x_diff_modified_insert', colors.diff_change)
Group.new('lualine_x_diff_modified_visual', colors.diff_change)
Group.new('lualine_x_diff_modified_replace', colors.diff_change)
Group.new('lualine_x_diff_modified_command', colors.diff_change)
Group.new('lualine_x_diff_modified_terminal', colors.diff_change)
Group.new('lualine_x_diff_modified_inactive', colors.diff_change)

Group.new('lualine_x_diff_removed_normal', colors.diff_delete)
Group.new('lualine_x_diff_removed_insert', colors.diff_delete)
Group.new('lualine_x_diff_removed_visual', colors.diff_delete)
Group.new('lualine_x_diff_removed_replace', colors.diff_delete)
Group.new('lualine_x_diff_removed_command', colors.diff_delete)
Group.new('lualine_x_diff_removed_terminal', colors.diff_delete)
Group.new('lualine_x_diff_removed_inactive', colors.diff_delete)
