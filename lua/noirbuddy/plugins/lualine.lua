...
Group.link('lualine_x_diff_added_normal', groups.DiffAdd)
Group.link('lualine_x_diff_added_insert', groups.DiffAdd)
Group.link('lualine_x_diff_added_visual', groups.DiffAdd)
Group.link('lualine_x_diff_added_replace', groups.DiffAdd)
Group.link('lualine_x_diff_added_command', groups.DiffAdd)
Group.link('lualine_x_diff_added_terminal', groups.DiffAdd)
Group.link('lualine_x_diff_added_inactive', groups.DiffAdd)

Group.link('lualine_x_diff_modified_normal', groups.DiffChange)
Group.link('lualine_x_diff_modified_insert', groups.DiffChange)
Group.link('lualine_x_diff_modified_visual', groups.DiffChange)
Group.link('lualine_x_diff_modified_replace', groups.DiffChange)
Group.link('lualine_x_diff_modified_command', groups.DiffChange)
Group.link('lualine_x_diff_modified_terminal', groups.DiffChange)
Group.link('lualine_x_diff_modified_inactive', groups.DiffChange)

Group.link('lualine_x_diff_removed_normal', groups.DiffDelete)
Group.link('lualine_x_diff_removed_insert', groups.DiffDelete)
Group.link('lualine_x_diff_removed_visual', groups.DiffDelete)
Group.link('lualine_x_diff_removed_replace', groups.DiffDelete)
Group.link('lualine_x_diff_removed_command', groups.DiffDelete)
Group.link('lualine_x_diff_removed_terminal', groups.DiffDelete)
Group.link('lualine_x_diff_removed_inactive', groups.DiffDelete)
